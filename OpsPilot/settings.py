...
INSTALLED_APPS = [
    ...
    # Applications
    'applications.dashboard.apps.DashboardConfig',
...
# TODO: change to smtp not backend
# Email settings
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@opspilot.com')
